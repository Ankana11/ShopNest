<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      <a class="sidebar-brand brand-logo" href="{{ route('admin.dashboard') }}"><h1 class="text-white">Admin</h1></a>
      <a class="sidebar-brand brand-logo-mini" href="{{ route('admin.dashboard') }}"><h1 class="text-white">A</h1></a>
    </div>
    <ul class="nav">
