                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            {{-- <div class="nav-item dropdown">
                                <a href="#" class="my-auto" data-bs-toggle="dropdown" <i class="fas fa-user fa-2x"></i></a>
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="cart.html" class="dropdown-item">Profile</a>
                                    <a href="chackout.html" class="dropdown-item">Order</a>
                                    <a href="chackout.html" class="dropdown-item">Register</a>
                                    <a href="chackout.html" class="dropdown-item">Login</a>
